...
function handlerMsgpackObject(obj) {
    for (let key in obj) {
        obj[key] = handlerMsgpack(obj[key])
    }
    return obj
}

function handlerMsgpack(obj) {
    return msgpack.decode(obj)
}

const rpc = function (data){
    return axios.post("192.168.2.34:7007/debug/", {"cmd": "magpack_pack", "data": data})
...
exports.handlerMsgpack = handlerMsgpack;
exports.handlerMsgpackObject = handlerMsgpackObject;
exports.rpc = rpc;
