        ...
        if (isConnected) {
            ...
            $.get('connections', function (data) {
                ...
                function getIconForType(type) {
                    switch (type) {
                        case 'root':
                            return 'images/treeRoot.png';
                        case 'string':
                            return 'images/treeString.png';
                        case 'hash':
                            return 'images/treeHash.png';
                        case 'set':
                            return 'images/treeSet.png';
                        case 'list':
                            return 'images/treeList.png';
                        case 'zset':
                            return 'images/treeZSet.png';
                        case 'stream':
                            return 'images/treeStream.png';
                        case 'binary':
                            return 'images/treeBinary.png';
                        case 'ReJSON-RL':
                            return 'images/treeJson.png';
                        default:
                            return null;
                    }
                }
    ...
    createJSONViews: function createJSONViews(jsonSelector) {
        $(jsonSelector).each(function () {
            ...
            try {
                ...
                current.jsonViewer(losslessJSON.parse(plain, losslessJsonReviver), {
                    withQuotes: true,
                    withLinks: false
                });
            } catch (ex) {
